            ...
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="page-item active">
                        <a class="page-link" href="Pergunta1_Nr10.php">1<span class="sr-only"></span></a>
                    </li>

                    <li class="page-item ">
                        <a class="page-link" href="Pergunta2_Nr10.php">2 </a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href="#">3</a></li>
                    <li class="page-item">
                        <a class="page-link" href="Pergunta1_Nr10.php">Próximo</a>
                    </li>
                </ul>
            </nav>
        </div>
